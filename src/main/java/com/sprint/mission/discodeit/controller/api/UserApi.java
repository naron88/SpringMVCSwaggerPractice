...
public interface UserApi {
  ...
  ResponseEntity<UserDto> createUser(
      @Parameter(
          ...
          content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE)) UserCreateRequest userCreateRequest,
      @Parameter(
          description = "User 프로필 이미지",
          content = @Content(mediaType = MediaType.MULTIPART_FORM_DATA_VALUE)) MultipartFile profile);
  ...
  ResponseEntity<UserDto> updateUser(@Parameter(description = "수정할 User ID") UUID userId,
